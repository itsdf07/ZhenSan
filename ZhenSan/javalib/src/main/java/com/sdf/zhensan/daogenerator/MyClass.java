package com.sdf.zhensan.daogenerator;
...
//      当然，如果你愿意，你也可以分别指定生成的 Bean 与 DAO 类所在的目录，只要如下所示：
     ...
     * @param schema
     */
    private static void addHeros(Schema schema) {
        // 一个实体（类）就关联到数据库中的一张表，此处表名为「Note」（既类名）
        Entity note = schema.addEntity(TABLE_HEROS);
        // 你也可以重新给表命名
        // note.setTableName(TABLE_HEROS);
        ...
        note.addStringProperty("camp");//阵营
    }
}
